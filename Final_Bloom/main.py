...
while done:
    ...
    if keys[pygame.K_UP] or keys[pygame.K_w] and collide == False:
        y -= vel * dt
        win.blit(player_back, (x, y))
    if keys[pygame.K_LEFT] or keys[pygame.K_a] and collide == False:
        x -= vel * dt
        win.blit(player_left, (x, y))
    if keys[pygame.K_RIGHT] or keys[pygame.K_d] and collide == False:
        x += vel * dt
        win.blit(player_right, (x, y))
    if keys[pygame.K_UP] or keys[pygame.K_s] and collide == False:
        y += vel * dt
        win.blit(player_front, (x, y))
    if keys[pygame.K_DOWN] and collide == False:
        y += vel * dt
    if keys[pygame.K_ESCAPE]:
        show_main_menu()
